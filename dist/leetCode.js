...
exports.languageStats = exports.trendingCategoryTopics = exports.problems = exports.selectProblem = exports.dailyProblem = exports.calendar = exports.ProblemStatusAndGenerateCSV = exports.problemStatusFromSheet = exports.problemStatus = exports.acSubmission = exports.submission = exports.solvedProblem = exports.userContestHistory = exports.userContest = exports.userBadges = exports.userData = void 0;
...
const problemStatus = (req, res) => {
    controllers.fetchProblemStatus({ username: req.query.username,
        problemName: req.query.problemName, }, res, gqlQueries.AcSubmissionQuery);
};
exports.problemStatus = problemStatus;
const problemStatusFromSheet = (_req, res) => {
    controllers.fetchProblemStatusFromSheet(_req, res, gqlQueries.AcSubmissionQuery);
};
exports.problemStatusFromSheet = problemStatusFromSheet;
const ProblemStatusAndGenerateCSV = (_req, res) => {
    controllers.fetchProblemStatusAndGenerateCSV(_req, res, gqlQueries.AcSubmissionQuery);
};
exports.ProblemStatusAndGenerateCSV = ProblemStatusAndGenerateCSV;
