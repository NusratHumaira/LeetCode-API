...
exports.fetchUsernamesFromSheet = exports.formatProblemStatus = exports.formatSubmissionCalendarData = exports.formatAcSubmissionData = exports.formatSubmissionData = exports.formatSolvedProblemsData = exports.formatContestHistoryData = exports.formatContestData = exports.formatBadgesData = exports.formatUserData = void 0;
...
const formatProblemStatus = (data) => ({
    isSolved: data.solved,
});
exports.formatProblemStatus = formatProblemStatus;
const fetchUsernamesFromSheet = async (sheetUrl) => {
    try {
        const response = await fetch(sheetUrl);
        const csvText = await response.text();
        const parsedData = (0, papaparse_1.parse)(csvText, {
            header: true,
            skipEmptyLines: true,
        });
        const usernames = parsedData.data.map((row) => row.username).filter(Boolean);
        return usernames;
    }
    catch (error) {
...
exports.fetchUsernamesFromSheet = fetchUsernamesFromSheet;
